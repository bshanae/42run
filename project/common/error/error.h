...
namespace 									common::error
{
	...
	messages_type							messages =
	{
		...
		{id::shader_file_error,           	"Engine : Can't read file"},
		...
		{id::texture_bad_format,          	"Engine : Bad format"},
		{id::event_bad_type,              	"Engine : Bad type"},
		{id::model_too_many_bones,        	"Engine : Mesh has too many bones"},
		{id::game_object_bad_logic,			"Engine : Logic error"},

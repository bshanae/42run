...
{
//						Lights
	lights_have_changed = not lights_to_include.empty() or not lights_to_exclude.empty();
...
//						Objects
	objects_have_changed = not objects_to_include.empty() or not objects_to_exclude.empty();
